          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              >
                ...
                <option value={2}>Mainan Anak</option>
                <option value={3}>Fancy / Produk Unik & Kekinian</option>
                <option value={4}>Peralatan Rumah Tangga</option>
                <option value={5}>Dekorasi Minimalis</option>
              </select>
            </div>
